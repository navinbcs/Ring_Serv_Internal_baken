...
class WebserviceModel extends CI_Model
{
  ...
  where u.TenantId =" . $TenantId);
    ...
    function getEnrollmentDetails($EnrollmentId)
    {
        ...
        T.TenantId,
        T.TenantName,
        T.Address TenantAddress,
        T.CountryId,
        T.postcode,
        CM.CountryDescription,
        CM.CurrencyName,
        CM.CurrrencyCode,
        SM.StateDescription,
        C.CityDescription,
        U.DisplayName DoctorFName,
        U.LastName DoctorLName,
        PM.PractitionerCode,
        PM.MMCNumber,
        PMS.SpecialityDescription Department
    ");
        ...
        $this->db->join("StateMaster SM", "SM.ID = T.StateID", "LEFT");
        $this->db->join("CityMaster C", "C.ID = T.CityID", "LEFT");

<?php
class AppointmentPayment extends CI_Controller
{
   ...
   //public $ringId;
    ...
    public function index(){
        ...
        $payload = [
                          ...
                          "response_url" => "https://apimobile.ring.healthcare/Ring_Dev/index.php/AppointmentPayment/successResponse", 
                          "payment_update_url" => "", 
                          "callback_url" => "", 
    ...
    function successResponse(){
        ...
        if(isset($_REQUEST["jwt"])){
            ...
            // }else if(($transactionData->result_code = 3900) && ($transactionData->payment_status == "CANCELLED")){
                ...
                $response['response_data'] = $insertArr;
                //redirect('https://apimobile.ring.healthcare:5026/Ring_Dev/index.php/AppointmentPayment/cancelResponse');
                ...
                //redirect('https://apimobile.ring.healthcare:5026/Ring_Dev/index.php/AppointmentPayment/timeoutResponse');
            }else{
                $response['response_code'] = '3';
                $response['response_message'] = 'Failled';
                //redirect('https://apimobile.ring.healthcare:5026/Ring_Dev/index.php/AppointmentPayment/failResponse');
            }

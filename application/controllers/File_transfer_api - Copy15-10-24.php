...
class File_transfer_api extends CI_Controller
{
	public function __construct()
    {
        ...
        // require(APPPATH . 'third_party/FPDI-2.3.7/src/fpdi.php');
        ...
        foreach($fileArrayAttachemnt as $fileVal){
            ...
            foreach($fileVal["FileAttachments"] as $fileAttchVal){
                ...
                if($ext == "pdf"){   
                    ...
                    // $str .= '<iframe src="https://apimobile.ring.healthcare:5026/Ring_dev/pdfDoc/'.$pdffilename1.'" width="600px" height="800px" style="border: 0;">
                    //     <p>
                    //         Your browser does not support PDF files.
                    //         <a href="https://apimobile.ring.healthcare:5026/Ring_dev/pdfDoc/'.$pdffilename1.'">Download the file instead</a>
                    //     </p>
                    // </iframe>';
                    // $str .= '</div>';   
                }else{   
    ...
    public function createOnePdfOfAllMRDTRecords(){
        ...
        if($data)
        {
            ...
            if($createPdf)
            {
                ...
                // $response['response_data1'] = $pdfFileArr;
                $response['fileWithPath'] = "https://apimobile.ring.healthcare:5026/Ring_dev/".$createPdf;
            }
            else
            {
                $response['response_code'] = '2';
        ...
        foreach($dataArray as $key=>$dataValue){
            ...
            <tr style="background: #03625c; border-collapse: collapse;">
                <td style="text-align: center; border-collapse: collapse;">
                    <div>
                        <img src="https://apimobile.ring.healthcare:5026/Ring_dev/assets/logo/ring_logo.png" width="100" />
                    </div>
                </td>

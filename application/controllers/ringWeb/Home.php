...
class Home extends CI_Controller {
  ...
  public function sendOtpMail()
	{
      $url = "https://win.k2key.in/Ring_dev/index.php/Webservice/GenerateOtp";
      $headers = array(
    ...
    public function validateOtp(){
        $otp = $_POST['otp'];
        $url = "https://win.k2key.in/Ring_dev/index.php/Webservice/userOTPValidateForWebPage";
        $headers = array(
				"Content-Type:application/json",
			);
        /*******************************************************/
    ...
    function getImgUrlFromBase64(){
      ...
      $url = "https://win.k2key.in/Ring_dev/index.php/Webservice/generateBase64ToImageLink";
      $headers = array(
				"Content-Type:application/json",
			);
        /*******************************************************/
